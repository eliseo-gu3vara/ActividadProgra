...
class InventarioApp(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle("Tienda UGB")
        self.resize(500, 420)
        ...
        # Etiqueta y lista principal de productos
        ...
        botones_layout.addWidget(self.recibo_button)
          ...
          # Layout para los botones de productos
...
if __name__ == "__main__":
    ...
    ventana.show()
    sys.exit(app.exec_())
>>>>>>> 620d817 (Modificando proyecto con archivo json para guardar productos y nuevas funcionalidades)
